...
//   // Add a variable to hold the assignment message
...
//
//                       // Update assignment message
//                       setState(() {
//                         assignmentMessage = 'Goal assigned to ${employee.name} (ID: ${employee.uid})';
//                       });
//
...
//                 if (assignmentMessage.isNotEmpty)
//                   Padding(
